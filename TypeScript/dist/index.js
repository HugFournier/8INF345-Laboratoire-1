...
var Article = /** @class */function () {
    function Article(ID, label, description, prix, image) {
        this.ID = ID;
        this.label = label;
...
var LoginController = /** @class */function () {
    ...
    LoginController.prototype.display = function () {
        var body = $('body');
        var htmlLogin = ViewMenu_1.getNav();
        htmlLogin += ViewLogin_1.generateHTMLFormLogin();
        body.html(htmlLogin);
